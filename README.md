...
* **Бренд:** название **EADUP** (включая вариации **eadup**, **Eadup**), созвучные или визуально схожие наименования (в частности **ADUP**, **adup**), а также логотип являются интеллектуальной собственностью **wellman4**. При создании производных продуктов (форков) или коммерческих сервисов на базе данного кода обязательна смена названия и визуальной айдентики. Использование оригинального бренда для сторонних проектов без согласия правообладателя запрещено.